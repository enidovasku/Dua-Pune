...
<body>
	<div class="header">
		...
		<ul>
		<img style="margin:0;padding-left: 20%;" src="images/worker.svg"/>
		<?php 
	...
	<div class="container-purpose">
		<div class="purpose">
			<center> "Karriera nis ketu!"</center>

		</div>
		<div class="search-container">
		<center><form method="get" action="jobs.php">
			<input type="text" placeholder="Kerko per pune ose kompani" name="search" />
